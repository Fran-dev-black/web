...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        $mensaje_turno="Su Turno se ha solicitado con éxito";
        #echo "<h2 style='color=blue; text-align:center;'> Su Turno se ha solicitado con éxito</h2>";
    } else {
...
?>
        <nav class="navbar">
            ...
            <ul class="menu">
                ...
                <li>
                    <a href="../servicio.html " style="font-family: Arial, Helvetica, sans-serif;">Servicio</a></li>
                <li>
        ...
        <div class="box">
            <h2 class="mensaje-turno" style=" text-align:center; background-color: #0077b6; padding: 10px 5px; margin:25px 10px ; font-family: Arial, Helvetica, sans-serif;">
                <?php echo $_SESSION['nombre'];?>
                <?php echo  $mensaje_turno; ?>
            </h2>
        </div>
